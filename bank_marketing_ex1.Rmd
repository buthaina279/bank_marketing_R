...
Due to the imbalance in the classes we are going to split the data set into train and test with stratified sample 
...
without the feature engineering the performance was 0.7763127 but after it the performance became 0.7721625 which mean the model performance improved

```{r}
#save.image("myWorkspace_ex1.rds")
```

```{r}
#load("myWorkspace_ex1.rds")
```
