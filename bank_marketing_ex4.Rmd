...
how can I calculate the error?? the accuracy?
```{r slide-17}
set.seed(123)
bank_gbm <- gbm(
  formula = (unclass(y)-1) ~ ., # unclass(y)-1 is to transform the number into {0,1} for bernoulli
  data = train,
...
#sqrt(bank_gbm$cv.error[min_MSE])
```
